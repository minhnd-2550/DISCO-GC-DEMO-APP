...
class _MovieApi implements MovieApi {
  ...
  @override
  Future<MovieImageDataModel> getMovieImages(
    movieId,
    key,
  ) async {
    const _extra = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MovieImageDataModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<MovieInfoDataModel> getMovieInfo(
    movieId,
    key,
  ) async {
    const _extra = <String, dynamic>{};
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<MovieInfoDataModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )

...
import 'package:flutter_clean_architecture/src/presentation/ui/booth_joining/component/comment_list.dart';
import 'package:flutter_clean_architecture/src/presentation/ui/booth_joining/component/video_view.dart';
import 'package:flutter_clean_architecture/src/presentation/ui/booth_joining/utils/jwt.dart';
...
class _CallScreenState extends State<CallScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
        ...
        showDialog<String>(
          ...
          builder: (BuildContext context) => AlertDialog(
            ...
            actions: <Widget>[
              TextButton(
                onPressed: () async => {
                  Navigator.popAndPushNamed(context, joinZoomPageRoutes,
                      arguments: JoinArguments(
                          args.isJoin,
                          args.sessionName,
                          "",
      ...
      final liveTranscriptionMsgInfoReceivedListener = emitter
          .on(EventType.onLiveTranscriptionMsgInfoReceived, (data) async {
        data = data as Map;
              ...
              if (userVolume < 10)
                {
                  await user.setUserVolume(
                      user.userId, userVolume + 1, isShareAudio),
                }
              else
                {
        ...
        options.add(ListTile(
            ...
            onTap: () async => {
                  ...
                  isVideoMirrored.value =
                      await zoom.videoHelper.isMirrorMyVideoEnabled(),
                  Navigator.of(context).pop(),
                }));
        options.add(ListTile(
            title: Text(
            ...
            Container(
                ...
                child: Stack(
                  children: [
                    ...
                    CommentList(zoom, eventListener),
                    moreOptions,
                  ],
                )),
          ],
